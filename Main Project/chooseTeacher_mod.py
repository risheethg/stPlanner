...
class MyForm(QtGui.QDialog):
    def __init__(self,parent=None):
        ...
        self.setWindowTitle("Choose Teacher")
        #Connect to DB
    ...
    def retrieve(self):
        ...
        try:
            ...
            cursor.execute("Select * from codes where code_type = 'a'")
            row = cursor.fetchall()
            self.conn.commit()
    ...
    def selected(self):
        selectedo = self.ui.lw_subjects.item(self.ui.lw_subjects.currentRow()).text();
        return selectedo;
